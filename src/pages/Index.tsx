    ...
    <Layout>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Why Choose <span className="text-gradient">ZAWPIE</span>?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 border border-gray-100 rounded-xl shadow-sm">
              <div className="w-16 h-16 bg-zawpie-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-zawpie-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
