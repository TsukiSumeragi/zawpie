        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/makeup" className="text-gray-300 hover:text-white transition-colors">
                  Makeup
                </Link>
              </li>
              <li>
                <Link to="/eyes" className="text-gray-300 hover:text-white transition-colors">
                  Eyes
                </Link>
              </li>
              <li>
                <Link to="/digital" className="text-gray-300 hover:text-white transition-colors">
                  Digital Devices
                </Link>
              </li>
            </ul>
